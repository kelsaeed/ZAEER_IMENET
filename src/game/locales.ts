...
const en: Record<string, string> = {
  ...
  'tutorial.lionFinale.body': 'The Lion kills ANY enemy in its path. An enemy guards the throne — move your Lion onto it to take the guard and win.',
...
const ar: Record<string, string> = {
  ...
  'tutorial.lionFinale.body': 'الأسد يقتل أي قطعة من الخصم في طريقه. هناك حارس على العرش — حرّك أسدك فوقه لتقتله وتفوز.',

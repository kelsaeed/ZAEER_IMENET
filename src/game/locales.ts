...
const en: Record<string, string> = {
  ...
  'tutorial.rescue.body': 'The enemy Bat has paralyzed your Lion. Move your Monkey onto the Bat to kill it and free the Lion.',
  'tutorial.rescue.done': 'Each piece can kill a specific other piece — that\'s the kill cycle. The Monkey beats the Bat.',
...
const ar: Record<string, string> = {
  ...
  'tutorial.rescue.body': 'خفاش الخصم شلّ أسدك. حرّك القرد فوق الخفاش لتقتله وتحرّر الأسد.',
  'tutorial.rescue.done': 'كل قطعة تقتل قطعة معيّنة — هذه دائرة القتل. القرد يهزم الخفاش.',

          ...
          <div className="flex flex-col items-center lg:items-stretch gap-5 sm:gap-6 w-full">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full max-w-md sm:max-w-none">
              <motion.button
                ...
                whileTap={{ scale: 0.96 }}
                className="px-5 py-4 sm:py-5 rounded-2xl text-base sm:text-lg font-extrabold w-full sm:flex-1 transition-all duration-300"
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.96 }}
                href="/play"
                className="px-5 py-4 sm:py-5 rounded-2xl text-base sm:text-lg font-extrabold text-center w-full sm:flex-1 transition-all duration-300 flex items-center justify-center gap-2"
                style={{
                  fontWeight: 800,
                  color: theme.textPrimary,
                  background: theme.panelBg,
